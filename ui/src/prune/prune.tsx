...
import { DataGrid, GridRowsProp, GridColDef, GridEventListener, gridPageSelector, gridPageCountSelector, useGridApiContext, useGridSelector, } from '@mui/x-data-grid';
...
export function Prune() {
  ...
  // const selectedImageArray = apiRef.current.getSelectedRows()
  ...
  useEffect(()=>{
    ...
    //    ddClient.docker.cli.exec('rmi', [...imageIdsToSpread])
    // } else {
    //   console.log('else')
    // }
  ...
  useEffect(()=>{
    // console.log('in useEffect',apiRef.current.getSelectedRows())
